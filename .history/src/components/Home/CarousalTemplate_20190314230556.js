...
import {
  ...
  export default class AddOption extends React.Component {
   ...
   <div>
    ...
    <button type="button" className="btn btn-success btn-shedule-service"  onClick={this.props.handleShow}>Shedule pickup </button>
    </div>
    </Carousel.Item>
    <Carousel.Item>
      <img
  ...
  <Dialog
          ...
          >
            ...
            <MuiPickersUtilsProvider utils={this.props.DateFnsUtils}>
          ...
          />
            <TimePicker className = "time-picker" value={this.props.selectedDate} onChange={this.props.handleDateChange} />           
             </div>
          </MuiPickersUtilsProvider>
          <TextField
                autoFocus
