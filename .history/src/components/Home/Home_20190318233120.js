...
class Home extends React.Component {
  ...
  render() {
    const {selectedDate,selectedTime, serviceRequest: {selectedService : values,name:values, email:values,mobileNumber:values, addressOne:values,addressTwo:values, landMark:values }} = this.state;
    // const { name, email, mobileNumber,addressOne , addressTwo, landMark  } = serviceRequest;
